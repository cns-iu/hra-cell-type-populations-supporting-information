...
const CTPOP_IRI = 'https://cns-iu.github.io/hra-cell-type-populations-supporting-information/data/enriched_rui_locations.jsonld#graph';
...
export async function getCtPopDb() {
  ...
  const ctpopQuads = await jsonld.toRDF(ctpopData, { format: 'application/n-quads' });
  oxigraph.load(ctpopQuads.toString(), 'text/turtle', undefined, namedNode(CTPOP_IRI));
