...
subset_sankey = sankey_universe_with_bins %>% 
  ...
  replace_na(list(organ_name = "Organ Not Supported")) %>% 
  ...
  # Recode strings that are too long
  subset_sankey$donor_race[subset_sankey$donor_race == "Greater Middle Eastern (Middle Eastern or North African or Persian)"] <- "Greater Middle Eastern"
  subset_sankey$donor_race[subset_sankey$donor_race == "Native American, Hispanic or Latin American"] <- "Native, Hispanic or Latin American"
  subset_sankey$organ_name[subset_sankey$organ_name == "Set of lactiferous glands in right breast"] <- "Breast"

  
  # Define the string to search for
search_string <- "Greater Middle Eastern"
# Filter the tibble to find all values in 'text_column' that contain 'search_string'
result <- subset_sankey %>%
  filter(str_detect(donor_race, search_string))
# Print the result
print(result)
