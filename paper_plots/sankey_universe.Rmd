...
cxg_age$donor_developmental_stage_cxg %>% unique

cxg_age %>% 
  mutate(
    contains_number = str_detect(donor_developmental_stage_cxg, "\\d"),
     extracted_number = str_extract(donor_developmental_stage_cxg, "\\d+")
         ) %>% view()
