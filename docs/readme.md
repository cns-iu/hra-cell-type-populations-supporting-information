...
Explore the Sankey diagram for the Input for the RUI2CTpop Workflow below (embedded) or [here](https://cns-iu.github.io/hra-cell-type-populations-supporting-information/sankey_atlas_plotly.html).
<iframe 
