...
rm(heart_annotation,lung_annotation,kidney_annotation,
   largeIntestine_annotation, smallIntestine_annotation,
   organ_as_ct_lookup)
```
...
# lung[is.na(lung$annotation_label),]$annotation_label <-
#   lung[is.na(lung$annotation_label),]$cell_label
# lung <- lung %>% mutate(cell_label2 = paste0(cell_id,": ",annotation_label))
...
# 
# lung <- lung %>%
#           ddply(.(tool,organ,as,cell_label2,asct_relation_in_asctb_table,
...
#   kidney[is.na(kidney$annotation_label),]$cell_label
# 
# kidney <- kidney %>% mutate(cell_label2 = paste0(cell_id,": ",annotation_label))
# # Remove common cell types
# kidney2 <-
#   kidney %>%
#   filter(!cell_id %in% cell_filter$cell_id)
...
```{r bar_heart, fig.height=14, fig.width=12, warning=FALSE}
...
### Lung
```{r bar_lung, fig.height=14, fig.width=21}
...
ggsave(file=paste0("../output/barplots/lung_as_celltype_bargraph_0.3.pdf"),
       barGraph_plot, width=21, height=12, units="in")
...
### Kidney
```{r bar_kidney, fig.height=7, fig.width=21}
...
ggsave(file=paste0("../output/barplots/kidney_as_celltype_bargraph_0.3.pdf"),
       barGraph_plot, width=21, height=7, units="in")
...
### Large Intestine
```{r bar_largeIntestine, fig.height=21, fig.width=21}
# Subset df2 to relevant organ
...
ggsave(file=paste0("../output/barplots/largeIntestine_as_celltype_bargraph_0.3.pdf"),
       barGraph_plot, width=21, height=21, units="in")
...
```{r bar_smallIntestine, fig.height=21, fig.width=21}
# Subset df2 to relevant organ
