...
piv <- df %>% 
  select(organ, tool, cell_label, percentage) %>%
  ddply(.(organ, tool, cell_label), summarise,
...
```{r barplot-heart_v0.2, fig.height=40, fig.width=15, warning=FALSE}
hrt %>% 
...
```{r barplot-lung_v0.2, fig.height=18, fig.width=15, warning=FALSE}
lng %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-liver_v0.2, fig.height=4, fig.width=15, warning=FALSE}
liv %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-breast_v0.2, fig.height=4, fig.width=15, warning=FALSE}
lgb %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-kidney_v0.2, fig.height=20, fig.width=15, warning=FALSE}
kid %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-largeIntestine_v0.2, fig.height=11, fig.width=15, warning=FALSE}
li %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-smallIntestine_v0.2, fig.height=11, fig.width=15, warning=FALSE}
si %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-skin_v0.2, fig.height=4, fig.width=15, warning=FALSE}
skin %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-spleen_v0.2, fig.height=5, fig.width=15, warning=FALSE}
spl %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-ureter_v0.2, fig.height=5, fig.width=15, warning=FALSE}
ute %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
