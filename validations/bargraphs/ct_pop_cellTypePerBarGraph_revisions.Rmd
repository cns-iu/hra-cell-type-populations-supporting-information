...
```{r barplot-heart, fig.height=40, fig.width=15, warning=FALSE}
hrt %>% 
...
```{r barplot-lung, fig.height=18, fig.width=15, warning=FALSE}
lng %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-liver, fig.height=4, fig.width=15, warning=FALSE}
liv %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-breast, fig.height=4, fig.width=15, warning=FALSE}
lgb %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-kidney, fig.height=20, fig.width=15, warning=FALSE}
kid %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-lrgIntestine, fig.height=11, fig.width=15, warning=FALSE}
li %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-smallIntestine, fig.height=11, fig.width=15, warning=FALSE}
si %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-skin, fig.height=4, fig.width=15, warning=FALSE}
skin %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-spleen, fig.height=5, fig.width=15, warning=FALSE}
spl %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
...
```{r barplot-ureter, fig.height=5, fig.width=15, warning=FALSE}
ute %>% 
  ggplot(aes(y=label, x=percentage)) +
  geom_col(aes(fill=cell_label)) +
  facet_grid(rows = vars(tool)) +
