...
data_spatial <- read.csv("../heatmaps/HRApop_Spatial_OASCT_CellCount_Percentage.csv",
                         header=T, fileEncoding = "UTF8")
...
data_scproteomics$cell_name <- 
  paste0(data_scproteomics$cell_id,": ",data_scproteomics$cell_label2)
